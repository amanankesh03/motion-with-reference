...
class ColorJitter(object):
    ...
    def __call__(self, img_source, img_target, img_ref):
        """
        Args:
        ...
        if isinstance(img_source, np.ndarray):
            ...
            with warnings.catch_warnings():
                ...
                for func in img_transforms:
                    ...
                    jittered_ref = func(img_ref).astype('float32')
            ...
            for func in img_transforms:
                ...
                jittered_ref = func(img_ref)

        else:
            raise TypeError('Expected numpy.ndarray or PIL.Image' +
                            'but got list of {0}'.format(type(img_source)))
        return jittered_source, jittered_target, jittered_ref
...
class AugmentationTransform:
    ...
    def __call__(self, img_source, img_target,img_ref):
        ...
        for t in self.transforms:
            img_source, img_target = t(img_source, img_target,img_ref)

        return img_source, img_target, img_ref
